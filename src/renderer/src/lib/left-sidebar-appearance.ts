...
function buildSurfaceVariables(args: {
  ...
  const vars: LeftSidebarStyleVariables = {
    ...
    '--worktree-sidebar-accent': `color-mix(in srgb, ${foreground} 9%, ${background})`,
    '--worktree-sidebar-accent-foreground': foreground,
    '--worktree-sidebar-border': `color-mix(in srgb, ${foreground} 14%, ${background})`,
    '--worktree-sidebar-ring': `color-mix(in srgb, ${foreground} 44%, ${background})`
  }
